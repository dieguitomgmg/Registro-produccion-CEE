...
if st.session_state.etapa == "linea":
    ...
    if st.session_state.mostrar_edicion:
        ...
        def formatear_registro(row):
            return f"{row['Fecha']} - {row['Hora']} - {row['CEE']} - {row['Línea']} - {row['Estación']} - {row['Operario']} - {row['Turno']} - {row['Producto']} - {row['Unidades producidas']} - {row['Unidades defectuosas']} - {row['Observaciones']}"
