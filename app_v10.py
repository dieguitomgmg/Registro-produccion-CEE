...
if "usuario_logueado" not in st.session_state or not st.session_state.usuario_logueado:
    ...
    # Mueve esto DESPUÉS de definir el widget 'modo'
    if st.session_state.get("registro_completado"):
        st.session_state.modo = "Iniciar sesión"   # Cambiar modo para mostrar login
        del st.session_state["registro_completado"]
        st.experimental_rerun()  # Forzar recarga para reflejar el cambio inmediatamente
