...
if st.session_state.etapa == "inicio_usuario":
    ...
    usuario_recuperar = st.text_input("👤 Introduce tu nombre de usuario (CEE)")
    ...
    if usuario_recuperar in usuarios:
        ...
        if pregunta:
            ...
            respuesta_introducida = st.text_input("✏️ Tu respuesta", type="password")
