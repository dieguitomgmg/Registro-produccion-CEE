...
if "usuario_logueado" not in st.session_state or not st.session_state.usuario_logueado:
    ...
    # Modo inicial según si hubo registro exitoso
    modo_inicial = "Iniciar sesión" if st.session_state.get("registro_completado") else st.session_state.get("modo", "Iniciar sesión")

    modo = st.radio("¿Tienes una cuenta?", ["Iniciar sesión", "Registrarse"],
                    index=["Iniciar sesión", "Registrarse"].index(modo_inicial),
                    key="modo")
...
# Finalmente, tras la reejecución, limpiar el flag para evitar loop
