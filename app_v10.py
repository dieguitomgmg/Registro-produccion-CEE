...
if modo == "Iniciar sesión":
    ...
    if st.button("Entrar"):
        if usuario in usuarios and usuarios[usuario]["clave"] == clave:
            ...
            st.session_state.etapa = "inicio"  # Avanzar al flujo principal
            st.rerun()
        else:
    ...
    if st.button("Registrarse"):
        if nuevo_usuario in usuarios:
            ...
            # Guardar usuario con sus líneas y estaciones
            ...
            # Cambiar modo a iniciar sesión automáticamente
