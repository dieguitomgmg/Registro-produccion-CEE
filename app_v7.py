...
if st.session_state.etapa == "CEE":
    cee = st.selectbox("Selecciona el CEE", cees, key="select_cee")
    ...
    linea = st.selectbox(f"Selecciona la línea de {st.session_state.cee}", lineas, key="select_linea")
    ...
    estacion = st.selectbox("Selecciona la estación", estaciones, key="select_estacion")
