...
# --- Botón para mostrar/ocultar editor de registros ---
...
# --- Editor de registros (solo si está activado) ---
if st.session_state.mostrar_editor:
    ...
    registro_seleccionado = st.selectbox(
        "Selecciona un registro para modificar o eliminar",
    ...
    nuevo_producto = st.selectbox("🧱 Producto", ["Producto A", "Producto B", "Producto C"],
                                  index=["Producto A", "Producto B", "Producto C"].index(registro["Producto"]),
                                  key="editar_producto")
    nuevas_producidas = st.number_input("🔢 Unidades producidas", min_value=0,
                                        value=int(registro["Unidades producidas"]), step=1,
                                        key="editar_producidas")
    nuevas_defectuosas = st.number_input("❌ Unidades defectuosas", min_value=0,
                                         value=int(registro["Unidades defectuosas"]), step=1,
                                         key="editar_defectuosas")
...
# --- Botones de navegación (siempre visibles, debajo del editor) ---
st.markdown("---")
